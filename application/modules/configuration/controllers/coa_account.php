...
class Coa_account extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->twiggy->title('OPSIFIN')->prepend('COA Account');;
        $this->twiggy->meta('keywords', 'twiggy, twig, template, layout, codeigniter');
        $this->twiggy->meta('description', 'Twiggy is an implementation of Twig template engine for CI');
        
         // create content page fo dp supplier
        $this->twiggy->set('BREADCRUMBS_TITLE', 'COA Account');
        $this->twiggy->set('BREADCRUMBS_MAIN_TITLE', 'Configuration');
        $this->twiggy->set('LIST_TITLE', 'COA Account');
    }
    ...
    function index()
    {
        ...
        $content .= $this->twiggy->template('list/coa_account')->render();
        ...
        $script_page = $this->twiggy->template('script/coa_account')->render();         
