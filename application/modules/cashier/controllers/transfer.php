...
class Transfer extends CI_Controller {
    function __construct() {
        ...
        $this->twiggy->title('OPSIFIN')->prepend('Transfer');;
        $this->twiggy->meta('keywords', 'twiggy, twig, template, layout, codeigniter');
        $this->twiggy->meta('description', 'Twiggy is an implementation of Twig template engine for CI');
        
        // create content page fo dp supplier
        $this->twiggy->set('BREADCRUMBS_TITLE', 'Transfer');
        $this->twiggy->set('BREADCRUMBS_MAIN_TITLE', 'Cashier');
        $this->twiggy->set('LIST_TITLE', 'Transfer');
    ...
    function index()
    {
       ...
       $data = array();
        ...
        $content .= $this->twiggy->template('list/transfer')->render();
        // end        
        ...
        $this->twiggy->set('FORM_LINK', site_url('cashier/transfer/delete'));
        
        $button_crud = $this->twiggy->template('button/btn_edit')->render();         
        $button_crud .= $this->twiggy->template('button/btn_del')->render();
        $this->twiggy->set('BUTTON_CRUD', $button_crud);
        
        $script_page = $this->twiggy->template('script/transfer')->render();         
    ...
    function form()
    {
        ...
        // create content page fo dp supplier
        $content = $this->twiggy->template('breadcrumbs')->render();
        $content .= $this->twiggy->template('form/form_transfer')->render();        
        // end        
        $this->twiggy->set('content_page', $content);
        ...
        $script_page = $this->twiggy->template('script/form_transfer')->render();         
    ...
    function save()
    {
        ...
        if (empty($valid))
            $this->owner->alert("Please complete the form", site_url('cashier/transfer/index'));
	else
            redirect(site_url('cashier/transfer/index'), "refresh");
    }   
