...
class Refund extends CI_Controller {
    ...
    function index()
    {
        ...
        $content .= $this->twiggy->template('list/refund')->render();
        // end        
        $this->twiggy->set('content_page', $content);
        
        $this->twiggy->set('FORM_NAME', 'form_refund');
        $this->twiggy->set('FORM_EDIT_IDKEY', 'data-edit-id');
        $this->twiggy->set('FORM_DELETE_IDKEY', 'data-delete-id');        
        $this->twiggy->set('FORM_IDKEY', 'full.id_refund');
        $this->twiggy->set('FORM_LINK', site_url('accounting/refund/delete'));
        
        $button_crud = $this->twiggy->template('button/btn_edit')->render();         
        $button_crud .= $this->twiggy->template('button/btn_del')->render();
        $this->twiggy->set('BUTTON_CRUD', $button_crud);
        
        $script_page = $this->twiggy->template('script/refund')->render();         
    ...
    function form()
    {
        ...
        $script_page = $this->twiggy->template('script/form_refund')->render();         
        //$script_page .= $this->twiggy->template('script/script_all')->render();         
